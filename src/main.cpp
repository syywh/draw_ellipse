...
// 	cloud->clear();
// 	cloud->push_back(pcl::PointXYZ(0.1,0.1,0));
// 	cloud->push_back(pcl::PointXYZ(0.35,0.35,0));
// 	cloud->push_back(pcl::PointXYZ(0.6,0.6,0));
// 	cloud->push_back(pcl::PointXYZ(1.1,0.1,0));
// 	cloud->push_back(pcl::PointXYZ(1.1,0.1,0.3));
// 	cloud->push_back(pcl::PointXYZ(0.1,1.1,0));
// 	cloud->push_back(pcl::PointXYZ(0.1,1.1,0.3));
// 	cloud->push_back(pcl::PointXYZ(1.1,1.1,0));
// 	cloud->push_back(pcl::PointXYZ(1.1,1.1,0.3));
// 	cloud->push_back(pcl::PointXYZ(2.1,1.1,0));
// 	cloud->push_back(pcl::PointXYZ(1.1,2.1,0));
// 	cloud->push_back(pcl::PointXYZ(1.1,2.1,0.3));
// 	cloud->push_back(pcl::PointXYZ(2.1,1.1,0.3));
// 	cloud->push_back(pcl::PointXYZ(1.6,1.6,0.6));
